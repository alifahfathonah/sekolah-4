...
<head>
    ...
    <title>Selamat datang di Website resmi SMK KAWUNG 1 SURABAYA</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <a href="<?php echo site_url('');?>" class="navbar-brand nav-brand2">SMK KAWUNG 1 SURABAYA<img class="img img-responsive" width="200px;" src=""></a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
               ...
               <p>SMK Kawung 1 Surabaya merupakan sekolah menengah kejuruan swasta di Surabaya yang menyelenggarakan pendidikan dengan jurusan Rekayasa Perangkat Lunak, Akuntansi Keuangan dan Lembaga,dan Otomatisasi Tata Kelola Perkantoran. </p>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="foot-logo">
                    ...
                    <p><?php echo date('Y');?> © copyright by <a  target="_blank">ICT SMK KAWUNG 1 SURABAYA</a>. <br>All rights reserved.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="sitemap">
